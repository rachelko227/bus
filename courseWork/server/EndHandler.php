...
class EndHandler implements RESTfulinterface {
  public function restGet($params) {
    include ('conn.php');
  
         // $sql = "SELECT routeNamee, locStartNamee, locEndNamee FROM route_bus WHERE locEndNamee LIKE '%$params[0]%'";
         ...
         FROM route_bus, rstop_bus WHERE locEndNamee LIKE '$params[0]'";
